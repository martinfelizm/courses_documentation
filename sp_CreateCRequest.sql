USE [Tasaciones]
GO
/****** Object:  StoredProcedure [dbo].[sp_CreateCRequest_tasacion]    Script Date: 7/20/2022 10:54:51 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
 ALTER 
     PROCEDURE [dbo].[sp_CreateCRequest_tasacion] (@objectIds varchar(200),@tableNewName varchar(max),@initSubstring int = 0, @folderDestino varchar(max))--[dbo].[sp_CreateCRequest_tasacion]686625489,'AccesoriosTasacion',0,'\\OPPCTEMP2\New folder (2)\Controllers\' 
AS
...
using Tasaciones.Core.Interfaces.InterfacesRepository;
...
+ '
    ...
    /// 
    /// </summary>
    public class Create' + @TableName + 'RequestValidator : CustomValidator<Create' + @TableName + 'Request>
    {
        /// <summary>
